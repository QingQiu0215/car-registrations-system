...
public class BenchMarkDriver3 
{
	...
	{		
		...
		try
		{
			inputF=new Scanner(new FileInputStream("ar_test_file3.txt"));
		...
		System.out.println(ar.nextKey("IMXPPN45QNQD"));
		System.out.println("==========prevKey==========================");
		System.out.println(ar.prevKey("IMXPPN45QNQD"));
		System.out.println("==========previousCars=====================");
		ArrayList<Node<String,String>> arr=ar.previousCars("IMXPPN45QNQD");
